...
def writeXml(xlscontent):
	...
	tranform = html_parser.unescape(json_data.toxml().decode('utf-8'))
	print tranform
	xmlcontent = xmlfile.createTextNode(r'%s' % tranform.decode('utf-8'))#str(xlscontent).decode('utf-8')) # 创建文本节点
